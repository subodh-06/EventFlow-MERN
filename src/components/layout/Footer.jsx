            ...
            <div className="flex w-full max-w-96 flex-col items-center gap-6 lg:items-start">
              <div>
                <span className="flex items-center justify-center gap-4 lg:justify-start">
                  <p className="text-3xl font-semibold text-[#1FDA8B]">EventFlow</p>
                </span>
                <p className="mt-4 text-sm text-gray-400">
                Plan and book unforgettable events effortlessly—grand celebrations, corporate gatherings, and intimate parties, all in one seamless platform.
                </p>
              </div>
